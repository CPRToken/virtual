...
export default async function handler(req: { method: string; body: { to: any; name: any; subject: any; text: any; downloadUrl: any; videoLink: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; json: { (arg0: { message?: string; error?: string; }): any; new(): any; }; }; }) {
  ...
  if (req.method === 'POST') {
    ...
    const mailOptions = {
      ...
      text: req.body.text,
        videoLink: req.body.downloadUrl,
      html: `
<img src="https://firebasestorage.googleapis.com/v0/b/virtual-c312e.appspot.com/o/public%2Fabove%20text%20copy.png?alt=media&token=97b8d649-d7b5-4a0d-9b69-78c283d5537f" alt="Virtual Eternity Logo" style="display: block; margin: 0 auto; width: 800px;">
       ...
       <div style="background-color: #f7f7f7; padding: 20px;">
        <div style="background-color: #ffffff; padding: 20px; border-radius: 5px; font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #444444;">
             ${req.body.name} te ha enviado un video privado titulado ${req.body.subject} <br>  <a href="${req.body.downloadUrl}">Ver video</a>
